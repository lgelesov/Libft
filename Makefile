...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/02/13 22:24:31 by ltrivinh          #+#    #+#              #
#    Updated: 2021/02/16 16:00:34 by ltrivinh         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
so:
	gcc -Wall -Wextra -Werror -fPIC -c $(SRCS) $(BSRCS)
	gcc -shared -o libft.so $(OBJECTS) $(BOBJS)
